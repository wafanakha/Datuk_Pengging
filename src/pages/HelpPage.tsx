    ...
    <div className="space-y-6">
      ...
      <Card title="Tentang SAPA Arcawinangun (Sistem Administrasi Pelayanan Arcawinangun)">
        <div className="space-y-4">
          ...
          <p className="text-gray-700">
            Aplikasi ini dibuat untuk beroperasi secara offline, artinya dapat
            digunakan tanpa koneksi internet. Semua data disimpan secara lokal
            pada perangkat yang digunakan, sehingga tidak memerlukan server atau
            hosting terpisah.
          </p>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-md p-4">
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-sm text-blue-700">Versi aplikasi: 0.4.0</p>
              </div>
            </div>
          </div>
        </div>
