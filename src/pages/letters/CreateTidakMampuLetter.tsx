    ...
    doc.text(
      `     Berdasakan Surat Keterangan dari Ketua Rukun Tetangga Nomor ${
        ...
        form.rtDate
          ...
          : "__________"
      }, bahwa yang bersangkutan betul warga Kelurahan Arcawinangun dan menurut pengakuan yang bersangkutan keadaan ekonominya TIDAK MAMPU.`,
      15,
      y,
      { maxWidth: pageWidth - 30 }
    );
      ...
      >
        ...
        <div className="mb-2">
          ...
          {form.rtDate
            ? new Date(form.rtDate).toLocaleDateString("id-ID")
            : "__________"}
          , bahwa yang bersangkutan betul warga Kelurahan Arcawinangun dan menurut
